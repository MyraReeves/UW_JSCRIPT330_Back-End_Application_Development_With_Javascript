...
2. Ensure you have git and github set up on your computer. If you do not, please follow this guide: [https://help.github.com/en/github/getting-started-with-github](https://help.github.com/en/github/getting-started-with-github).
